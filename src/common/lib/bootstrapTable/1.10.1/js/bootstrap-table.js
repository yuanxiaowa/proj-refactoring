...
! function($) {
  ...
  BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
    ...
    formatDetailPagination: function(totalRows) {
      return sprintf('搜索结果：共 <span class="text-warning">%s</span> 条', totalRows);
    },
  ...
  BootstrapTable.prototype.initToolbar = function() {
    ...
    if (typeof this.options.toolbar === 'string' || typeof this.options.toolbar === 'object') {
      $(sprintf('<div class="columns columns-right pull-%s"></div>', this.options.toolbarAlign))
        .appendTo(this.$toolbar)
        .append($(this.options.toolbar));
    }
    this.$toolbar.append('<div class="pagination-detail bs-bars">');
  };
  ...
  BootstrapTable.prototype.initPagination = function() {
    ...
    html.push(
      ...
      '</span>');
    this.$toolbar.find('.pagination-detail').html(this.options.formatDetailPagination(this.options.totalRows));
  ...
  BootstrapTable.prototype.initBody = function(fixedScroll) {
    ...
    this.$body.find('> tr[data-index] > td > .detail-icon').off('click').on('click', function() {
      ...
      // remove and update
      if ($this.find('i').hasClass(that.options.icons.detailClose)) {
